...
class SiT(nn.Module):
    ...
    def __init__(
        ...
        **block_kwargs,  # fused_attn, qk_norm
        ...
        self.attr_embedders = nn.ModuleList(
            [
                LabelEmbedder(nc, hidden_size, class_dropout_prob)
                for nc in attr_num_classes
            ]
        )
    ...
    def initialize_weights(self):
        ...
        # nn.init.normal_(self.ch_embedder.embedding_table.weight, std=0.02)
        # nn.init.normal_(self.ct_embedder.embedding_table.weight, std=0.02)
        for emb in self.attr_embedders:
            nn.init.normal_(emb.embedding_table.weight, std=0.02)
