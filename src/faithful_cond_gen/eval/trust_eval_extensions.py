...
def compute_global_realism_z(
    ...
    real_E_std: float,
    batch_size: int = 2000,
    two_sided: bool = True,  # Use z² instead of z (H2 evidence: over-typical samples invert one-sided)
) -> np.ndarray:
    """
...
# ============================================================================
# Task 5: Downstream Bin-Selection Helpers
# ============================================================================
