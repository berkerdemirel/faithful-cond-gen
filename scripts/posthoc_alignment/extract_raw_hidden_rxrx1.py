"""Extract mean-pooled raw hidden features at multiple timesteps for mapper training (RxRx1).

For each real RxRx1 training image and each timestep t:
...
Usage:
    ...
    PYTHONPATH=src uv run python scripts/posthoc_alignment/extract_raw_hidden_rxrx1.py \
        checkpoint_key=rxrx1_vanilla_marginal_v1
...
from faithful_cond_gen.data.rxrx1 import RxRx1DataModule
...
@hydra.main(
    config_path="../../configs",
    config_name="extract_raw_hidden_rxrx1",
    version_base="1.3",
)
